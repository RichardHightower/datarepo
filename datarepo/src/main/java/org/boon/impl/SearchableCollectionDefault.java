...
import org.boon.impl.indexes.UniqueLookupIndex;
import org.boon.query.Query;
import org.boon.query.Selector;
import org.boon.query.Sort;
import org.boon.query.Visitor;
import org.boon.spi.FilterComposer;
import org.boon.spi.SearchIndex;
import org.boon.spi.SearchableCollectionComposer;
...
public class SearchableCollectionDefault<KEY, ITEM> implements SearchableCollection<KEY, ITEM>, SearchableCollectionComposer {
    ...
    public void setFilter(org.boon.Filter filter) {
        this.filter = filter;
    }
